...
/* cinto e suspensório: a troca usa el.hidden, e isto garante o efeito
   mesmo que o reset do host não venha. */
#site[hidden],#plataforma[hidden]{display:none!important}
"""
